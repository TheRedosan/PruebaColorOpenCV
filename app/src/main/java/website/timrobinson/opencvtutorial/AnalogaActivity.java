...
public class AnalogaActivity extends AppCompatActivity implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            ...
            switch (status) {
                ...
                case LoaderCallbackInterface.SUCCESS: {
                    ...
                    OpenCvCamara.setOnTouchListener(AnalogaActivity.this);
